...
(cl:defmethod cl:initialize-instance :after ((m <SquareService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SquareService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name trail-srv:<SquareService-request> is deprecated: use trail-srv:SquareService-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <SquareService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader trail-srv:a-val is deprecated.  Use trail-srv:a instead.")
  (a m))
...
(cl:defmethod cl:initialize-instance :after ((m <SquareService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SquareService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name trail-srv:<SquareService-response> is deprecated: use trail-srv:SquareService-response instead.")))

(cl:ensure-generic-function 'square-val :lambda-list '(m))
(cl:defmethod square-val ((m <SquareService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader trail-srv:square-val is deprecated.  Use trail-srv:square instead.")
  (square m))
